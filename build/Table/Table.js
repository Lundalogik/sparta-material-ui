...
var Table = function (_Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(_ref, [this].concat(args))), _this), _this.onCellClick = function (rowNumber, columnNumber, event) {
    ...
    }, _this.onRowSelection = function (selectedRow) {
      if (_this.props.onRowSelection) _this.props.onRowSelection(selectedRow);
    }, _this.onSelectAll = function () {
      if (_this.props.onRowSelection) {
        if (!_this.props.allRowsSelected) {
